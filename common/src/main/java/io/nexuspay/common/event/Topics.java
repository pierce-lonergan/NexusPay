...
public final class Topics {
    ...
    /** B2B payment lifecycle events (purchase orders, invoices, virtual cards, vendor payments). Partition key: aggregate_id. */
    public static final String B2B_EVENTS = "nexuspay.b2b.events";
