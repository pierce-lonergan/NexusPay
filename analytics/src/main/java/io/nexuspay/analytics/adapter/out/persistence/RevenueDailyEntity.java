...
/**
 * JPA entity for the {@code analytics.revenue_daily} table.
 * <p>Daily revenue aggregates including volume, fees, net revenue,
 * refunds, and chargebacks.</p>
 *
 * @since 0.3.0 (Sprint 3.6)
 */
@Entity
@Table(name = "revenue_daily", schema = "analytics")
public class RevenueDailyEntity {
    ...
    protected RevenueDailyEntity() {}

    public RevenueDailyEntity(UUID id, String tenantId, LocalDate bucketDate,
