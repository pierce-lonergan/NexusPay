 ...
 * bootstrap against. The security filter chain mirrors the production semantics from the iam module's
 * {@code SecurityConfig}: stateless API, CSRF disabled, 401 on missing auth, {@code @PreAuthorize}
 * enforced. Added in SEC-BATCH-1 to support {@code FraudRuleControllerTest}.</p>
 */
@SpringBootApplication
@EnableMethodSecurity
public class FraudTestApplication {
